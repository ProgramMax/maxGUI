...
namespace maxGUI
{
	...
	HWND DropDownBox::Create(HWND parent_window_handle, max::Containers::Rectangle<int, int> rectangle, std::vector<std::string> list, DropDownBoxStyles styles) noexcept {
