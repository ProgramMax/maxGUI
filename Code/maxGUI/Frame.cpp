...
namespace maxGUI
{
	...
	Frame::Frame(HWND window_handle) MAX_DOES_NOT_THROW
		: ControlWithText(std::move(window_handle))
	{}
	
	HWND FrameFactoryImplementationDetails::CreateFrame(std::string text, Rectangle rectangle, HWND parent_window_handle) MAX_DOES_NOT_THROW {
