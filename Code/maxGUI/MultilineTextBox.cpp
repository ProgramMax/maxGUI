...
#if defined(MAX_PLATFORM_WINDOWS)
	HWND MultilineTextBox::Create(HWND parent_window_handle, max::Containers::Rectangle<int, int> rectangle, std::string text, MultilineTextBoxStyles styles) noexcept {
